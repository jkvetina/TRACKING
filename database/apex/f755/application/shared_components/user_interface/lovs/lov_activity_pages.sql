prompt --application/shared_components/user_interface/lovs/lov_activity_pages
begin
--   Manifest
--     LOV_ACTIVITY_PAGES
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(99912103699010580)  -- LOV_ACTIVITY_PAGES
,p_lov_name=>'LOV_ACTIVITY_PAGES'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
