...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(124287812619403280)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94148115355026808)
,p_plug_template_id=>wwv_flow_imp.id(124287812619403280)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94148622905026808)
,p_plug_template_id=>wwv_flow_imp.id(124287812619403280)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94149116670026808)
,p_plug_template_id=>wwv_flow_imp.id(124287812619403280)
,p_name=>'Button Start'
