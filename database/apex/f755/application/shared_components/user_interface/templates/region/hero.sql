...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(124262451698403265)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94084397554026763)
,p_plug_template_id=>wwv_flow_imp.id(124262451698403265)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94084904202026763)
,p_plug_template_id=>wwv_flow_imp.id(124262451698403265)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94085381275026764)
,p_plug_template_id=>wwv_flow_imp.id(124262451698403265)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94085952515026764)
,p_plug_template_id=>wwv_flow_imp.id(124262451698403265)
,p_name=>'Sub Regions'
