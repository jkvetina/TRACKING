...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(124265675568403268)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94091365701026768)
,p_plug_template_id=>wwv_flow_imp.id(124265675568403268)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94091904554026768)
,p_plug_template_id=>wwv_flow_imp.id(124265675568403268)
,p_name=>'Sub Regions'
