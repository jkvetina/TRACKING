...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(124305307100403290)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94194825242026842)
,p_plug_template_id=>wwv_flow_imp.id(124305307100403290)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94195339743026842)
,p_plug_template_id=>wwv_flow_imp.id(124305307100403290)
,p_name=>'Tabs'
