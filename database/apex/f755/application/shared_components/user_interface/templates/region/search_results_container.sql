...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(124292745066403283)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94160710325026817)
,p_plug_template_id=>wwv_flow_imp.id(124292745066403283)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94161234736026817)
,p_plug_template_id=>wwv_flow_imp.id(124292745066403283)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94161740541026817)
,p_plug_template_id=>wwv_flow_imp.id(124292745066403283)
,p_name=>'Sub Regions'
