...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(124236586126403249)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94017681858026714)
,p_plug_template_id=>wwv_flow_imp.id(124236586126403249)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94018190855026714)
,p_plug_template_id=>wwv_flow_imp.id(124236586126403249)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94018752329026714)
,p_plug_template_id=>wwv_flow_imp.id(124236586126403249)
,p_name=>'Sub Regions'
