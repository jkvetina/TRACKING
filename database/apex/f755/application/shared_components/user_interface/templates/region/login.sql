...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(124290282433403281)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94154912972026813)
,p_plug_template_id=>wwv_flow_imp.id(124290282433403281)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94155381357026813)
,p_plug_template_id=>wwv_flow_imp.id(124290282433403281)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94155942251026813)
,p_plug_template_id=>wwv_flow_imp.id(124290282433403281)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94156360591026814)
,p_plug_template_id=>wwv_flow_imp.id(124290282433403281)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(94156909010026814)
,p_plug_template_id=>wwv_flow_imp.id(124290282433403281)
,p_name=>'Sub Regions'
