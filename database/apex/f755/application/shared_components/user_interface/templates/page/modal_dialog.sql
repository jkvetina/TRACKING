...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(124210788196403229)
,p_theme_id=>700
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93939768074026661)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93940316127026661)
,p_page_template_id=>wwv_flow_imp.id(124210788196403229)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93940839521026662)
,p_page_template_id=>wwv_flow_imp.id(124210788196403229)
