...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(124190169913403216)
,p_theme_id=>700
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93883697030026623)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93884245817026624)
,p_page_template_id=>wwv_flow_imp.id(124190169913403216)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93884738732026624)
,p_page_template_id=>wwv_flow_imp.id(124190169913403216)
